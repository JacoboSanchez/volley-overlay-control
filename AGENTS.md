...
- **Error tracking:** Sentry is inert unless `SENTRY_DSN` is configured. `SENTRY_ENVIRONMENT`, `SENTRY_RELEASE`, and `SENTRY_TRACES_SAMPLE_RATE` tune it; the setup scrubs bodies, cookies, query strings, and capability-bearing URL paths.
