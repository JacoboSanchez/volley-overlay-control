...
- CustomOverlayBackend: communicates with an external overlay server via
  WebSocket (preferred) with HTTP fallback
- LocalOverlayBackend: manages overlay state in-process (no external server)
"""
...
# ---------------------------------------------------------------------------
# Local (in-process) overlay backend
# ---------------------------------------------------------------------------
