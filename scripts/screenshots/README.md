...
| `10-overlay-set-summary.png` | Set-summary recap overlay (Rallies / `brand_ledger` variant) using a scoreboard's native light palette at `/overlay/{public_token}`, at the canonical OBS browser-source size. | 1280×720 (overlay HD) |
