...
describe('ScoreTable', () => {
  ...
  it('renders scores for completed sets', () => {
    renderWithI18n(<ScoreTable state={mockGameState} setsLimit={5} currentSet={2} teamId={1} />);
  ...
  it('pads scores to two digits', () => {
    ...
    renderWithI18n(<ScoreTable state={state} setsLimit={5} currentSet={2} teamId={1} />);
  ...
  it('does not apply score-bold when team is losing a set', () => {
    renderWithI18n(<ScoreTable state={mockGameState} setsLimit={5} currentSet={2} teamId={2} />);
  ...
  it('shows all set scores when match is finished', () => {
    ...
    renderWithI18n(<ScoreTable state={state} setsLimit={5} currentSet={3} teamId={1} />);
