...
const translations: Record<string, TranslationDict> = {
  en: {
    ...
    'presets.lastApplied': 'Last applied: {name}',
  ...
  es: {
    ...
    'presets.lastApplied': 'Último aplicado: {name}',
  ...
  it: {
    ...
    'presets.lastApplied': 'Ultimo applicato: {name}',
  ...
  fr: {
    ...
    'presets.lastApplied': 'Dernier appliqué : {name}',
  ...
  de: {
    ...
    'presets.lastApplied': 'Zuletzt angewendet: {name}',
