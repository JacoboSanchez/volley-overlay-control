...
# Only load .env if NOT testing AND NOT on Android
if not is_pytest and not is_android:
    from dotenv import load_dotenv
    load_dotenv()
...
if __name__ in {"__main__", "__mp_main__"}:
    ...
    ui.run(title=title, favicon=custom_favicon, on_air=onair, port=port, storage_secret=secret, show=show, reload=reload, host='localhost')